...
Clone the project on [GitHub](https://github.com/narekhovhannisyan/express-mongo-basic-app.git)
   
   ``` bash
   $ git clone https://github.com/narekhovhannisyan/express-mongo-basic-app.git
   $ cd express-mongo-basic-app
   ```
